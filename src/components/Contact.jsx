...
const Contact = () => {
  ...
  return (
    <Box as="section" id="contacto" bgGradient="linear(to-br, gray.50, blue.50)" py={{ base: 16, lg: 24 }} px={{ base: 4, sm: 6, lg: 8 }}>
      <Container maxW="7xl">
        <VStack spacing={16}>
          {/* Header */}
          <VStack spacing={4} textAlign="center">
            ...
            <Heading as="h2" size="2xl" color="gray.800">
              Ponte en <Text as="span" className="gradient-text">Contacto</Text>
            </Heading>
            <Text
              fontSize="lg"
              color="gray.600"
          ...
          <SimpleGrid columns={{ base: 1, lg: 3 }} spacing={8} w="full">
            ...
            <VStack spacing={6}>
              ...
              >
                <CardBody p={8}>
                  <Heading as="h3" size="md" color="gray.800" mb={6}>
                    ...
                    {contactInfo.map((info, index) => (
                      <Flex key={index} align="center" gap={4} w="full">
                        <Box p={3} bg="blue.50" borderRadius="lg">
                          <Icon as={info.icon} boxSize={5} color="blue.600" />
                        </Box>
                        <Box>
